    ...
    <SidebarProvider>
      <Sidebar className="fixed top-[62px] left-0 h-[0px] bg-[#121212] border-0 text-white  transition-all w-16 lg:w-56">
        <SidebarMenu className="">
          <SidebarMenuItem
            onClick={() => navigate("/")}
            className="flex gap-2 text-md lg:p-4 h-12 mt-5 font-bold justify-center items-center lg:justify-start cursor-pointer hover:bg-[#30303051]  w-[90%] rounded-md"
          >
            <RiHome4Line size={22} />
          ...
          <SidebarMenuItem
            ...
            className="flex gap-2 text-md lg:p-4 h-12  font-bold justify-center items-center lg:justify-start cursor-pointer hover:bg-[#30303051]  w-[90%] rounded-md"
          >
